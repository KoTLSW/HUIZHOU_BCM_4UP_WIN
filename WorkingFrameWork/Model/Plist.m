...
-(NSMutableArray *)PlistRead:(NSString *)fileName Key:(NSString *)key
{
    ...
    if (arrayData != nil && ![arrayData isEqual:@""])
    {
        ...
        //拼接到暴露外界的字符串上
         _titile = [NSMutableString stringWithFormat:@"%@%@%@%@",[@"Start_Time,End_Time,Version,NestID,Product_Type,Config,SN,TestResut,FixtureID,Operator_ID,Total," stringByAppendingString:titileString],[@"\nMAX,,,,,,,,,,,"  stringByAppendingString:upperString],
